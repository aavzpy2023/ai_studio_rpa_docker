...
ALTER TABLE IF EXISTS ONLY public.bff_vendor DROP CONSTRAINT IF EXISTS bff_vendor_idrepresentative_fkey;
...
ALTER TABLE IF EXISTS ONLY public.bff_vender_representative DROP CONSTRAINT IF EXISTS bff_vender_representative_idvendor_fkey;
ALTER TABLE IF EXISTS ONLY public.bff_vender_representative DROP CONSTRAINT IF EXISTS bff_vender_representative_idtype_fkey;
...
ALTER TABLE IF EXISTS ONLY public.bff_vender_representative DROP CONSTRAINT IF EXISTS bff_vender_representative_pkey;
...
ALTER TABLE IF EXISTS ONLY public.bff_contry DROP CONSTRAINT IF EXISTS bff_contry_pkey;
...
DROP TABLE IF EXISTS public.bff_vender_representative;
...
CREATE TABLE public.bff_contry (
    id integer NOT NULL,
    contry character varying(50) NOT NULL
);
...
ALTER TABLE public.bff_contry ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
--
-- Name: bff_vender_representative; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.bff_vender_representative (
    id integer NOT NULL,
    idvendor integer,
    idtype integer
);
...
ALTER TABLE public.bff_vender_representative ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
COPY public.bff_contact (id, type_id, responsibility_id, first_name, second_name, line1, line2, city, county, idstate, country_id, phone, mobile, email, isowner, active, created_at, updated_at) FROM stdin;
\.
...
COPY public.bff_contact_type (id, type, created_at, updated_at) FROM stdin;
\.
...
COPY public.bff_contry (id, contry) FROM stdin;
1	United States
\.
...
COPY public.bff_responsibility (id, responsibility, isfinalcustomer, created_at, updated_at) FROM stdin;
\.
...
COPY public.bff_state (id, idcontry, state) FROM stdin;
1	1	Alabama
2	1	Alaska
3	1	Arizona
4	1	Arkansas
...
--
-- Data for Name: bff_vender_representative; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.bff_vender_representative (id, idvendor, idtype) FROM stdin;
\.
...
1	SALES_READ	View sales data	sales	2026-01-23 20:30:04.703675+00	\N
2	INVENTORY_READ	View inventory	inventory	2026-01-23 20:30:04.703675+00	\N
3	USERS_READ	View users	users	2026-01-23 20:30:04.703675+00	\N
4	USERS_WRITE	Modify users	users	2026-01-23 20:30:04.703675+00	\N
\.
...
1	admin	admin@dfgchatai.com	$2b$12$z1r0BtMaqIvrY.VBVcM29u9SWtxsrqpIb.cgOyVCeYrS5cUGAuCA6	System	Administrator	Root	\N	00000000000	1	t	2026-01-21 13:28:37.149478	2026-01-23 21:39:35.25575+00	0	\N
\.
...
hwXSmrNQVA8l2oUp	Unnamed Project	personal	2026-01-21 13:28:39.751+00	2026-01-21 13:28:39.751+00	\N
\.
...
4eeb4321-ca35-4f58-b3c3-8443dda322b4	\N	\N	\N	\N	\N	2026-01-21 13:28:39.221+00	2026-01-21 13:28:39.221+00	{"userActivated": false}	f	f	\N	\N	global:owner
\.
...
SELECT pg_catalog.setval('public.bff_contact_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.bff_contact_type_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.bff_customers_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.bff_responsability_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.dff_permission_id_seq', 5, false);
...
SELECT pg_catalog.setval('public.dff_role_id_seq', 9, false);
...
SELECT pg_catalog.setval('public.dff_users_id_seq', 2, true);
...
--
-- Name: bff_contry bff_contry_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bff_vender_representative bff_vender_representative_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bff_vender_representative
...
ALTER TABLE ONLY public.bff_competence
    ADD CONSTRAINT bff_competence_idcontry_fkey FOREIGN KEY (idcontry) REFERENCES public.bff_contry(id);
...
ALTER TABLE ONLY public.bff_contact
    ADD CONSTRAINT bff_contact_idcontry_fkey FOREIGN KEY (country_id) REFERENCES public.bff_contry(id);
...
ALTER TABLE ONLY public.bff_contact
    ADD CONSTRAINT bff_contact_idstate_fkey FOREIGN KEY (idstate) REFERENCES public.bff_state(id);
...
ALTER TABLE ONLY public.bff_customers
    ADD CONSTRAINT bff_customers_idcontry_fkey FOREIGN KEY (idcontry) REFERENCES public.bff_contry(id);
...
ALTER TABLE ONLY public.bff_state
    ADD CONSTRAINT bff_state_idcontry_fkey FOREIGN KEY (idcontry) REFERENCES public.bff_contry(id);


--
-- Name: bff_vender_representative bff_vender_representative_idtype_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bff_vender_representative bff_vender_representative_idvendor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.bff_vendor
    ADD CONSTRAINT bff_vendor_idcontry_fkey FOREIGN KEY (idcontry) REFERENCES public.bff_contry(id);


--
-- Name: bff_vendor bff_vendor_idrepresentative_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bff_vendor
    ADD CONSTRAINT bff_vendor_idrepresentative_fkey FOREIGN KEY (idrepresentative) REFERENCES public.bff_contact(id);
